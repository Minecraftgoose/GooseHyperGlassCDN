...
declare module './index' {
  interface LiquidGlassRenderer {
    gooseFBO(w: number, h: number): { fb: WebGLFramebuffer; tex: WebGLTexture }
    gooseResizeFBO(w: number, h: number): void
    gooseBindFBO(fb: WebGLFramebuffer | null): void
    gooseCopy(srcTex: WebGLTexture): void
    gooseFill(r: number, g: number, b: number, a: number): void
    ...
    gooseColorCtrl(srcTex: WebGLTexture, brightness: number, contrast: number, saturation: number): void
  }
}
...
export const fboMethods = {
  ...
  gooseResizeFBO(this: LiquidGlassRenderer, w: number, h: number) {
  ...
  gooseBindFBO(this: LiquidGlassRenderer, fb: WebGLFramebuffer | null) {
    const gl = this.gl
    gl.bindFramebuffer(gl.FRAMEBUFFER, fb)
  ...
  gooseCopy(this: LiquidGlassRenderer, srcTex: WebGLTexture) {
    const gl = this.gl
